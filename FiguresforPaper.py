...
fig_fitnessB, leftax = plt.subplots(figsize=(10,5), sharex=True, constrained_layout=False)
...
fig_fitnessB.savefig('fig_fitnB.png', dpi = 300)
fig_fitnessB.savefig('Fig_fitnB.svg') 
plt.show(fig_fitnessB) 

#Panel C***********************
fig_fitnessC, hostC = plt.subplots(figsize=(10,5), sharex=True, constrained_layout=False)
...
fig_fitnessC.savefig('fig_fitnC.png', dpi = 300)
fig_fitnessC.savefig('fig_fitnC.svg')  
...
plt.show(fig_feeding)
      
#Figure with individual trajectories of growth and surv
fig_indsurv,  hostA=plt.subplots(figsize=(10,5),sharex=True, constrained_layout=False)
...
fig_indsurv.savefig('fig_indsurv.png', dpi = 300)
fig_indsurv.savefig('fig_indsurv.svg')  

#Figure of egg fitness sensitivity
fig_survsens,  hostA=plt.subplots(figsize=(10,5),sharex=True, constrained_layout=False)
...
fig_survsens.savefig('fig_survsens.png', dpi = 300)
fig_survsens.savefig('fig_survsens.svg')  


#***************
#Next figure require new iterations
TempFood_test = True
...
for Tp in T_range:
    for ration in range(ration_range):
        ...
        for i_h in range(4,28):
             ...
             #The gut is a container which determines if the larva can grow at max rate, limited by temperature or food
             Food_enc = (ration/(ration_range*15))*w0*LightLim[h_time,180]  #ration in fractions of bm per forging day length
...
fig_gDataField.savefig('fig_gDataField.svg', dpi = 300)
fig_gDataField.savefig('fig_gDataField.png', dpi = 300)
